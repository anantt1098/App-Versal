  ...
  return (
    <div className="space-y-6 pb-6">
      ...
      <div className="bg-zinc-900/80 border border-zinc-800/90 rounded-2xl p-4 space-y-4 shadow-sm hover:border-zinc-700/80 transition-colors">
        <div className="flex items-center justify-between border-b border-zinc-800 pb-3">
          <div className="flex items-center gap-2">
            <span className="w-6 h-6 rounded-lg bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 font-bold text-xs flex items-center justify-center">
              1
            </span>
            <h3 className="font-semibold text-zinc-100 text-sm">Initial Feedback Screen</h3>
          </div>
          <button
            type="button"
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-zinc-100 focus:outline-none focus:border-indigo-500 resize-none"
            />
          </div>

          <div className="space-y-1">
            <label className="text-xs font-medium text-zinc-300">Start Button Text</label>
            <input
              type="text"
              value={content.initialPage.buttonText || 'Give Feedback'}
              onChange={(e) => updateInitial('buttonText', e.target.value)}
              placeholder="Button label..."
              className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-1.5 text-xs text-zinc-100 focus:outline-none focus:border-indigo-500"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-zinc-900/80 border border-zinc-800/90 rounded-2xl p-4 space-y-4 shadow-sm hover:border-zinc-700/80 transition-colors">
        <div className="flex items-center justify-between border-b border-zinc-800 pb-3">
          <div className="flex items-center gap-2">
            <span className="w-6 h-6 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-400 font-bold text-xs flex items-center justify-center">
              2
            </span>
            <h3 className="font-semibold text-zinc-100 text-sm">Feedback Screen</h3>
          </div>
          <button
            type="button"
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-zinc-100 focus:outline-none focus:border-indigo-500 font-medium"
            />
          </div>

          {/* Rating Type Switcher */}
          <div className="space-y-1.5">
            <label className="text-xs font-medium text-zinc-300">Rating System Type</label>
          ...
          <div className="flex items-center justify-between p-3 bg-zinc-950/70 rounded-xl border border-zinc-800">
            <div className="space-y-0.5">
              ...
              <p className="text-[11px] text-zinc-400">Allow users to type custom detailed feedback</p>
            </div>
            <button
              type="button"
          ...
          {content.feedbackPage.showCommentArea && (
            <div className="space-y-1">
              <label className="text-xs font-medium text-zinc-400">Comment Placeholder</label>
              <input
                type="text"
          ...
          {/* Submit Button Text */}
          <div className="space-y-1">
            <label className="text-xs font-medium text-zinc-300">Submit Button Text</label>
            <input
              type="text"
              ...
              className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-1.5 text-xs text-zinc-100 focus:outline-none focus:border-indigo-500 font-medium"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-zinc-900/80 border border-zinc-800/90 rounded-2xl p-4 space-y-4 shadow-sm hover:border-zinc-700/80 transition-colors">
        <div className="flex items-center justify-between border-b border-zinc-800 pb-3">
          <div className="flex items-center gap-2">
            <span className="w-6 h-6 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 font-bold text-xs flex items-center justify-center">
              3
            </span>
            <h3 className="font-semibold text-zinc-100 text-sm">Thank You Screen</h3>
          </div>
          <button
            type="button"
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1">
            <label className="text-xs font-medium text-zinc-300">Button Text</label>
            <input
              type="text"
